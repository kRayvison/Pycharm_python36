...
class C4dPluginMgr(object):
    ...
    def get_dll(self,soft_version):
        ...
        print (r'C:/fcopy/FastCopy.exe /speed=full /force_close /no_confirm_stop /force_start "' + dll_src + '" /to="' + soft_src + '"')
        os.system (r'C:/fcopy/FastCopy.exe /speed=full /force_close /no_confirm_stop /force_start "' + dll_src + '" /to="' + soft_src + '"')
    ...
    def set_custom_env(self, plugin):
        ...
        if plugin.plugin_name == 'c4dtoa':
            ...
            rd_lic_src = os.path.join(self.plugin_root, r'plugins\C4D', self.plugin.plugin_name, 'AMPED')
            print (rd_lic_src + '@KANADA_amped_src')
            rd_lic_dest = r"C:/AMPED/"
            ...
            print ('echo f | xcopy /f /y "%s" "%s"' % (rd_lic_src, rd_lic_dest))
