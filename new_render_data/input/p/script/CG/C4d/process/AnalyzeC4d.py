...
class AnalyzeC4d(C4d):
    def __init__(self, **paramDict):
        ...
        self.plugin_config_result = False
    '''
    ...
    def RB_CONFIG(self):
        ...
        self.plugin_config_result = self.plugin_config()
