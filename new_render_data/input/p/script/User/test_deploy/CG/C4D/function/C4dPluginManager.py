...
class C4dPluginMgr(object):
    ...
    def exit(self):
        ...
        kill_command = r'C:\script/new_py/CG/C4d/function/taskkill.exe /F /IM "CINEMA 4D.exe"'
    ...
    def __maxon_install_path(self):
        # C:\Program Files\MAXON\CINEMA 4D R13\plugins
...
if __name__ == "__main__":
    ...
    plugin_mgr = C4dPluginMgr('100000',r'\\10.60.100.151\td')
