...
class RBMaxLog(object):
    def __init__(self,task_id,cg_version,log_obj,log_work,action_id): 
            ...
            self.MAX_LOG1=r'C:\Program Files\Autodesk\{}\Network\Max.log'.format(cg_version)
            if not os.path.exists(self.MAX_LOG) and os.path.exists(self.MAX_LOG1):
                self.MAX_LOG = self.MAX_LOG1
