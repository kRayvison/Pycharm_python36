...
class RBCommon(object):
    ...
    def cmd_python3(self,cmd_str,my_log=None):
        ...
        python_path = ur'c:\python34\python.exe'
        script_path = u'C:\\script\\new_py\\Util\\RunCmd.py'
        run_cmd_txt = u'C:\\script\\new_py\\RunCmd.txt'
        
        cmd_str_u = self.str_to_unicode(cmd_str)
        ...
        cmd_p3=ur'%s "%s" "%s"' % (python_path,script_path,run_cmd_txt)
