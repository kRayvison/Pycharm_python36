        ...
        if os.path.exists(dir):
            ...
            for root, dirs, files in list_dirs: 
                for name in files:
                    ...
                    self.G_DEBUG_LOG.info('root='+str(os.path.exists(root)))  #test
                    self.G_DEBUG_LOG.info('work_small_tmp_pic='+str(type(work_small_tmp_pic)))  #test
                    self.G_DEBUG_LOG.info('work_big_pic_tmp='+str(type(work_big_pic_tmp)))  #test
                    self.G_DEBUG_LOG.info('work_big_pic_tmp='+str(os.path.exists(work_big_pic_tmp)))  #test
                    self.G_DEBUG_LOG.info('work_big_pic_tmp='+str(os.path.exists(work_big_pic_tmp.encode(sys.getfilesystemencoding()))))  #test
                    ...
                    self.G_DEBUG_LOG.info('convert_cmd='+str(type(convert_cmd)))  #test
                    try:
