...
class RenderBase():
    ...
    def rendering_copy_notify(self, start_or_end='0'):
        ...
        self.G_DEBUG_LOG.info('[BASE.rendering_copy_notify.start.....')
        ...
        if os.path.exists(api_json_path):
            ...
            for rendering_copy_interface in rendering_copy_interface_list:
                self.G_DEBUG_LOG.info('rendering_copy_interface:%s' % rendering_copy_interface)
                ...
                try:
                    ...
                    self.G_DEBUG_LOG.info('[warn]url can\'t open:%s' % rendering_copy_interface)
