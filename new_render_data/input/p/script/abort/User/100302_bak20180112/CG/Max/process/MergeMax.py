...
class MergeMax(Max):
    ...
    def RB_RENDER(self):
        ...
        if self.G_MULTI_CAMERA:
            ...
            photon_user_path=os.path.join(self.G_TEMP_PATH,'photon',self.G_CG_OPTION)
    ...
    def result_action_photon(self):
        ...
        if self.G_MULTI_CAMERA:
            upload_path = os.path.join(self.G_INPUT_PROJECT_PATH,'photon',self.G_SMALL_TASK_ID,self.G_CG_OPTION)
