        ...
        if os.path.exists(dir):
            ...
            for root, dirs, files in list_dirs:
                for name in files:
                    ...
                    convert_cmd = '{exe_path} -out jpeg -resize {w} {h} -overwrite -o "{output_file}" "{converted_file}"'.format(
                    ...
                    if ext == '.exr' and os.path.exists(oiio_path):
                        ...
                        convert_cmd = '{exe_path} "{converted_file}" -resize {w}x{h} -o "{output_file}"'.format(
                            exe_path = oiio_path,
                            w = small_width,
                            h = small_height,
                            output_file = work_small_tmp_pic,
