...
class RBFrameChecker(object):
    ...
    def get_file_size(self,local_path,server_path,my_log=None):
        ...
        CLASS_COMMON_UTIL.str_to_unicode(local_path)
        CLASS_COMMON_UTIL.str_to_unicode(server_path)
        check_file = []
    ...
    def check_texture(self,nuke_path,texture_file,my_log=None):
        run_path = nuke_path
        CLASS_COMMON_UTIL.str_to_unicode(run_path)
        #print texture_file
        ...
        for i in texture_file :
            ...
            if i.split('.')[-1] not in texture_type:
                ...
                CLASS_COMMON_UTIL.log_print(my_log,u' This file does not support Nuke do check'+i)
