...
class C4dParser():
    ...
    def analyze(self, *args):
        ...
        save options
        """
        save_click = int(rd[c4d.RDATA_SAVEIMAGE])
        saveimage_path = rd[c4d.RDATA_PATH]
        print save_click, saveimage_path
        _save_data = {}
        _save_data['save_click'] = save_click
        _save_data['saveimage_path'] = saveimage_path
        self.scene_common_dict['save_options'] = _save_data
    ...
    def parse_realflow(self):
        if os.path.exists(self.asset_json_dict['realflow_mesh']):
            print _realflow_mesh + 'rrrrrrrrrrrr'
    ...
    def parse_texture(self, textures):
        ...
        for texture in textures:
            ...
            # 仅有贴图名检查
                ...
                print root_dir + '00000000000000000'
