...
if sys.platform.startswith("linux"):
    sys.path.insert(0,os.path.join(os.path.dirname(__file__), "tim", "linux_py27"))
...
if __name__ == '__main__':
    ...
    if len(kwargs["tile_files"]) == kwargs["tiles"]:        
        merge(kwargs)
    else:
        raise AssertionError("the merge_images  render is  faile , pls check tile task ")
        exit(1)
