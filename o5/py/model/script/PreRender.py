...
currentPath = r"\\10.60.100.101\o5\py\model"
...
class PreRender(dict,PreRenderBase):
    ...
    def get_scene_info(self):
        ...
        if renderer == "vray":
            ...
            if arnold_options_node.hasAttr("autotx"):
                arnold_options_node.autotx.set(l=0)
    ...
    def han_custome_prerender_bak(self):
        ...
        if self.user_id in [101763711111]:
            print self.plugins
            print "+++++++++++++++++++++++self.mapping+++++++++++++++++++++++"
            print self.mapping
            print "self.rendersetting"
        ...
        if self.user_id in [1855708, 900045, 1855110, 1833038, 1834849, 1826800, 1860992, 1163411, 1862577,
                            1830380,
                            1822281, 1852326, 1868563, 963140, 1862389, 1865352, 1864255, 1870881, 1879938,
                            1833958,
    ...
    def main(self):
        if self.user_id not in [1813119,962276,1820648]:
            self.get_scene_info()
