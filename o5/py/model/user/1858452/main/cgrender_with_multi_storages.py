...
class MayaClass(Render):
    ...
    def set_plugins_myx(self):
        ...
        if self["common"]["userId"] in [1868564,1897994,1883721,1879938]:
...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        HQID_YZC = [1821228, 962413, 1821226, 1821229, 1821231, 1821234, 1821235, 1868236, 1868237, 1868238, 1868370,
                    1868371, 1868372, 1868373, 1868374, 1868375, 1868376, 1868377, 1868379, 1868380, 1868382, 1868383,
                    1868384]
        HQID_XCM = [1914329,1914331,1914334,1914336,1914342,1914343,1914344,1914345,1913765]
        
        if self["common"]["userId"] not in [1911075,1909920,1818014, 1844854, 1875231, 1846887, 1854355, 1814593, 963931, 1873017,
                                            1812148, 1812148, 1830380, 1871175, 1899488, 1820991,1919164,1914329,1914331,1914334,1914336,1914342,1914343,1914344,1914345,1913765]:
        ...
        if self["server"]["user_id"] in HQID_XCM:
        ...
        if self["server"]["user_id"] in [1919164]:
            ...
            if os.path.exists(r'B:\custom_config\962413\lzSolutionPackage\plug-ins\x64\2017\lzSolutionPackage.mll'):
                os.system(r'xcopy /y /f B:\custom_config\962413\lzSolutionPackage\plug-ins\x64\2017\lzSolutionPackage.mll "C:\Program Files\Autodesk\Maya2017\bin\plug-ins\"')
            cmd += " -preRender \"source \\\"//10.60.100.151/td/clientFiles/962413/render_command_light_new_2018DY_hqft02.mel\\\"\"" 
