...
class Render(dict, Zip7):
    ...
    def mapping_plugins(self):
        ...
        if self["common"]["userId"] in [1857988]:
...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if self["common"]["userId"] not in [1909920,1818014, 1844854, 1875231, 1846887, 1854355, 1814593, 963931, 1873017,
        ...
        if "RenderMan_for_Maya" in self["plugins"]["plugins"]:
            ...
            if self["common"]["userId"] in [1814593]:
                cmd += " -ris "
        elif "3delight" in self["plugins"]["plugins"] or "3delightformaya" in self["plugins"]["plugins"] :
