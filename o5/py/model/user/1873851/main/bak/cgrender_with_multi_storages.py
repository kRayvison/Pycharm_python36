...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if self["common"]["userId"] in [1873851]:
        ...
        if self["common"]["userId"] not in [1818014, 1844854, 1875231, 1846887, 1854355, 1873851 ,1814593, 963931, 1873017,
                                            1812148, 1812148, 1830380, 1871175, 1899488, 1820991] and self["common"]["userId"] not in HQID and "-preRender" not in cmd:
