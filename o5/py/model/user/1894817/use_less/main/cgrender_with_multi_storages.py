...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        PreRender = os.path.join(self["platform"]["py_path"],'PreRender_1868564.py').replace("\\","/")
        pre_render_dict = {}
        pre_render_dict["mapping"] = self["mappings"]
        pre_render_dict["user_id"] = self["common"]["userId"]
        pre_render_dict["taskid"] = self["common"]["taskId"]
        ...
        if self["common"]["userId"] not in [1818014, 1844854, 1875231, 1846887, 1854355, 1814593, 963931, 1873017,
